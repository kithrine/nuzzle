  ...
  return (
    <>
      ...
      <div className="mt-2 flex flex-col gap-2">
        <Link
          href="/questionnaire"
          className="bg-secondary-cta text-white rounded-button-inline text-sm font-semibold px-4 py-2 text-center hover:opacity-90 transition-opacity"
        >
          Get My Match
        </Link>
        <Link
...
function AuthenticatedBody({
  ...
  return (
    <>
      ...
      <Link
        href={detailHref}
        className="mt-2 bg-primary text-white rounded-button-inline text-sm font-semibold px-4 py-2 text-center hover:opacity-90 transition-opacity"
      >
        View Details
      </Link>
    </>
